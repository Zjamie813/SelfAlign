...
class PrecompDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(cap_caption)
        # cut the captions if len > max_len
        ...
        '''
        target:initial token_ids,is number
        cap_caption:cut tokens,is str,no padding ,but cut
        caption_label:processed token_ids,is number,padding and cut
        '''
...
def collate_fn(data):
    ...
    lengths = [len(cap) for cap in captions] # captions is the initial token_ids
    ...
    '''
    targets: current batch max_len token_ids [bt,37]
    caption_labels: configrure max_len token_ids [bt,61]
    caption_labels larger than targets
    '''
