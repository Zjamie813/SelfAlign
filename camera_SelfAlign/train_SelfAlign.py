...
def main():
    ...
    parser.add_argument('--data_path', default='./scan_data', help='path to datasets')
    ...
    parser.add_argument("--bert_path", default='./uncased_L-12_H-768_A-12/', type=str, help="The BERT model path.")
