...
from evaluation_SelfAlign import i2t, t2i, AverageMeter, LogCollector, encode_data, calItr
import logging
...
def main():
    ...
    parser.add_argument('--data_path', default='/data2/yjgroup/zjm/dataset/scan_data', help='path to datasets')
    ...
    parser.add_argument('--lr_decay_gamma', default=0.1, type=float, help='Decay coefficient for learning rate updating')
    ...
    parser.add_argument('--max_violation', type=bool,default=True,help='Use max instead of sum in the rank loss.')
    parser.add_argument('--img_dim', default=2048, type=int, help='Dimensionality of the image embedding.')
    # /home/zjm/download/pretrain/models/CAMERA_bert/uncased_L-12_H-768_A-12/
    # /data2/yjgroup/zjm/pretrain_model/models/camera_bert/uncased_L-12_H-768_A-12/
    parser.add_argument("--bert_path", default='/data2/yjgroup/zjm/pretrain_model/models/camera_bert/uncased_L-12_H-768_A-12/', type=str, help="The BERT model path.")
    ...
    # my settings
    parser.add_argument('--ctx_fc_relu', type=int, default=1, help='1:true,0:false,default False')
    parser.add_argument('--local_clu_num', type=int, default=1024, help='softmax temperature,{2,5,0.2}')
    parser.add_argument('--v5_tao', type=float, default=0.7, help='softmax temperature')
    parser.add_argument('--v6_tao', type=float, default=0.7, help='softmax temperature')


    # abl settings
    parser.add_argument('--local_tea', type=str, default='CRS', help='T,CRS')
